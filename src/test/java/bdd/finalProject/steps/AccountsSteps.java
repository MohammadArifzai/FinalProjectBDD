...
import bdd.finalProject.pages.AccountPage;
...
public class AccountsSteps extends SeleniumUtilities {
    ...
    public void user_should_see_five_rows_per_page_by_default() {
        Object AccountsPage;
        List<WebElement> rows = BaseSetup.getDriver().findElements(AccountPage.PRIMARY_ACCOUNTS_ALL_ROWS);
    ...
    public void user_should_see_rows_per_page(String expectedRows) {
        int actualRows = BaseSetup.getDriver().findElements(AccountPage.PRIMARY_ACCOUNTS_ALL_ROWS).size();
