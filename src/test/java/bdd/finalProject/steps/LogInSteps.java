...
public class LogInSteps extends SeleniumUtilities {
    ...
    public void user_enters_valid_username_and_password(String username, String password) {
        ...
        Assert.assertTrue(userNameInputField.isDisplayed() && userNameInputField.isEnabled(),
                "Username input field is not visible or enabled");
        Assert.assertTrue(passwordInputField.isDisplayed() && passwordInputField.isEnabled(),
